        ...
        <section className="section-home">
            ...
            <div className="container_splitter_home">
                <div className="container_logo">
                    ...
                    <button onClick={() => window.location.href = `/product`}>Conheça nossos produtos</button>
                </div>
                <div className="h-full">
                    <ZSplitter className="h-full">
                        <ZSplitterPanel className="relative  h-full w-full" size={25}><Image alt="" fill
                            style={{ objectFit: "cover" }} src={home_right} /></ZSplitterPanel>
                        <ZSplitterPanel className="relative  h-full w-full" size={75}><Image alt="" fill
